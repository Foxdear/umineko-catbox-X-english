...
* Halved wait times for a line of dialogue with disjointed waits so it works better with English text (the dialogue starts to play before the words are seen) (52811)
...
* Episode 7's "`Do you wish to proceed?`" scene in Chapter 2 was heavily modified in the original patch. It included font-size changes, purposefully (I imagine) awkward staggered wait times, and a line that makes the text box fill the screen. The format used in Umipro and the original Switch version is much more simple and subtle by comparison. I feel odd removing it, since this is a very purposeful change, but it felt very off to me as a reader and it is not part of the original experience. I've changed this to be more in line with what Umipro has, though adjusted slightly due to the differences and limitations in font use. (49713, 49715, 49717, 49722, 49723)